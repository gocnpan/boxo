...
func resolvePathWithRootsAndBlock(ctx context.Context, fpath path.ImmutablePath, unixFSLsys *ipld.LinkSystem) ([]cid.Cid, cid.Cid, []string, blocks.Block, error) {
...
func resolvePathToLastWithRoots(ctx context.Context, fpath path.ImmutablePath, unixFSLsys *ipld.LinkSystem) ([]cid.Cid, cid.Cid, []string, blocks.Block, error) {
